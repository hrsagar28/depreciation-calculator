...
export const getDaysUsed = (purchaseDateStr, disposalDateStr = null, fyStartDate, fyEndDate) => {
    const currentFYStart = new Date(fyStartDate);
    const financialYearEnd = new Date(`${fyEndDate}T23:59:59`);
